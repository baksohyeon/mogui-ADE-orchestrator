...
class ProposerContext:
    """Everything a proposer is allowed to see for one iteration."""

    iteration: int
    workspace_dir: Path
    current: Candidate
    visible_cases: Tuple[VerificationCase, ...]
    visible_failures: Tuple[CaseResult, ...]
