...
- **Inherited Role**: Reference Implementation (Role Lock ENABLED — 승계는 역할을 바꾸지 않는다). Gen 4 대의 Role Switch(Release/Operations → Reference Implementation, R+0 Owner 승인)를 그대로 상속
